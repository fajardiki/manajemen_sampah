            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                   <a class="btn btn-xs default" href="javascript:;" id="form_act">
                    ...
                    <input type="hidden" name="id_nasabah" id="id_nasabah" value=""/>
                                         <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">

                                                <tr>
                                                   <td colspan="6" style="font-weight:bold"> Detail Nasabah </td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="nama_nasabah" id="nama_nasabah" tabindex="1"> </td>
                                                     <td width="150px"> Nomor Rek </td>
                                                    <td width="10px"> : </td>
                                                    <td>  
                                                      <input type="text" class="form-control"  
                                                      value="<?php 
                                                      if(strlen($last_rekening)==1){
                                                          echo "000".$last_rekening;
                                                        }elseif(strlen($last_rekening)==2){
                                                           echo "00".$last_rekening;
                                                          }elseif(strlen($last_rekening)==3){
                                                              echo "0".$last_rekening;
                                                            }elseif(strlen($last_rekening)>=4){
                                                               echo $last_rekening;
                                                            }
                                                      ?>" tabindex="1" readonly>
                                                      <input type="hidden" class="form-control" name="no_rek" id="no_rek" value="<?php echo $last_rekening?>" tabindex="1" readonly> </td>
                                                </tr> 
                                                 
                                               <tr>
                                                    <td width="150px"> Nomor KTP </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="no_ktp" id="no_ktp" tabindex="1"> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="no_telp" id="no_telp" tabindex="1"> </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="date" class="form-control" name="tgl_lahir" id="tgl_lahir" tabindex="1" > </td>
                                                      <td width="150px"> Username </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="username" id="username" tabindex="1"> </td> 
                                                </tr> 
  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_nasabah/view", // define ajax source URL
        "sServerMethod": "POST"
      });
...
function set_val(data) {
  // body...
   ...
   $.post('<?php echo base_url()?>c_nasabah/dataedit', {id_nasabah: data}, function(respond) {  
                  
                  $("#id_nasabah").val(respond[0].id_nasabah);
                 
                  $("#nama_nasabah").val(respond[0].nama_nasabah);
                
                  $("#jenis_kelamin").val(respond[0].jenis_kelamin);
                
                  $("#tgl_lahir").val(respond[0].tgl_lahir);
                
                  $("#alamat").val(respond[0].alamat);
                  $("#no_telp").val(respond[0].no_telp);
                  $("#username").val(respond[0].username);
                  $("#no_ktp").val(respond[0].no_ktp);
                 
                  $("#no_rek").val(respond[0].no_rek);
...
function set_del(data) {
  if( confirm("Apakah data ingin dihapus ?") ){
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>c_nasabah/delete',
                data: { id : data },
                success: function(data) {
                    if(data === 'true')
                    // $('#cancel').click();
