  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_report/view_report", // define ajax source URL
        "sServerMethod": "POST"
      });
...
function detail_report(id_nasabah) {
   
   window.location.href = "<?php echo base_url()?>c_report/detail_report/"+id_nasabah;
}
    </script>
  </body>
</html>
