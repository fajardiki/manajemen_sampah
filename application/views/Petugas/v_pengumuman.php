            ...
            <div class="panel-heading" role="tab" id="headingOne">
                <h4 class="panel-title">
                   <a class="btn btn-xs default" href="javascript:;" id="form_act">
                    ...
                    <input type="hidden" name="id_pengumuman" id="id_pengumuman" value=""/>
                                         <div class="table-responsive">
                                        <table class="table table-striped table-bordered table-hover table-checkable order-column" id="sample_1">

                                                <tr>
                                                   <td colspan="6" style="font-weight:bold"> Detail Pengumuman </td>
                                                 ...
                                                 <tr>
                                                    ...
                                                    <td>  
                                                     ...
                                                     <td width="150px"> Judul Pengumuman </td>
                                                    <td width="10px"> : </td>
                                                    <td>  <input type="text" class="form-control" name="judul" id="judul" tabindex="1"> </td>
                                                </tr> 
                                                 <tr>

                                                     <td width="150px"> Isi Pengumuman  </td>
                                                    <td width="10px"> : </td>
                                                    <td colspan="6">  <input type="text" class="form-control" name="isi_pengumuman" id="isi_pengumuman" tabindex="1"> </td>
  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_pengumuman/view", // define ajax source URL
        "sServerMethod": "POST"
      });
    ...
    $(document).ready(function() {
      ...
      $('#save').click(function(){
       if ($('#id_nasabah').val() == "") {
          ...
          alert("Judul Pengumuman harus di isi");
          $('#judul').focus();
          return false;
        }else if ($('#isi_pengumuman').val() == "") {
          alert("Isi Pengumuman harus di isi");
          $('#isi_pengumuman').focus();
          return false;
        }else {
...
function set_val(data) {
  // body...
   ...
   $.post('<?php echo base_url()?>c_pengumuman/dataedit', {id_pengumuman: data}, function(respond) {  
                  
                  $("#id_pengumuman").val(respond[0].id_pengumuman);
                 
                  $("#id_nasabah").val(respond[0].id_nasabah);
                
                  $("#judul").val(respond[0].judul);
                  $("#isi_pengumuman").val(respond[0].isi_pengumuman);
...
function set_del(data) {
  if( confirm("Apakah data ingin dihapus ?") ){
    $.ajax({
                type: 'POST',
                url: '<?php echo base_url() ?>c_pengumuman/delete',
                data: { id : data },
                success: function(data) {
                    if(data === 'true')
                    // $('#cancel').click();
