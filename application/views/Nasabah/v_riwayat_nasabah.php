...
<div class="row">
  <div class="col-lg-12">
    ...
    <div class="portlet box green">
      <div class="portlet-title">
        <div class="caption">
          <i class="fa fa-globe"></i>
          <big>Data Penarikan Saldo</big>
        </div>
        <div class="actions"></div>
      </div>
      <div class="portlet-body">
        <div id="view-table">
          <table class="table table-bordered" id="table-penarikan">
                      <thead>
                        <tr>
                          <th>Nomor</th>
  ...
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "sAjaxSource": "<?php echo base_url(); ?>c_riwayat_nasabah/view_menabung", // define ajax source URL
        "sServerMethod": "POST"
      });
 ...
 var TableAdvancedPenarikan = function () {
  var initTable1 = function() {
    ...
    */
    ...
    var oTable = $(target).dataTable( {
        ...
        "bProcessing": true, // enable/disable display message box on record load
        "bServerSide": true, // enable/disable server side ajax loading
        "sAjaxSource": "<?php echo base_url(); ?>c_riwayat_nasabah/view_penarikan", // define ajax source URL
        "sServerMethod": "POST"
      });
